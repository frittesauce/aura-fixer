...
const props = defineProps(["id", "name", "description", "email", "imageId", "longitude", "latitude"]);
...
<template>
    <div class="w-screen">
        <div
            ...
            <div>
                <img src="/images/fish.png" class=" max-w-64 max-h-64 min-h-64 min-w-64">
            </div>
            <div class=" max-w-[400px]">
                <h1 id="title" class="text-2xl mb-1">kapoten vis</h1>
